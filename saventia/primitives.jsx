/* Reusable primitives for Saventia — Aurora Glass system. */
(function () {
  ...
  function Button({ variant = 'primary', children, onClick, href, type, full, style }) {
    ...
    const variants = {
      primary: {
        ...
        color: '#04130D',
        boxShadow: hover ? '0 12px 34px rgba(16,185,129,0.42), 0 0 0 1px rgba(52,224,168,0.4)'
  ...
  function IconTile({ name }) {
    return (
      <span style={{
        ...
        background: 'linear-gradient(135deg, rgba(52,224,168,0.16), rgba(45,107,255,0.10))',
        ...
        {['fr', 'en'].map(l => {
          ...
          return (
            <button key={l} onClick={() => onChange(l)} aria-pressed={active} style={{
              ...
              color: active ? '#04130D' : 'var(--text-muted)',
